...
<title>Recherche des Reservations par Salle</title>
<script src="script/jquery-3.6.0.min.js"></script>
<script src="script/reservationRecharche.js"></script>
				...
				<div class=" mt-4">
					<div class="card">
						<div class="card-header pb-0 px-3">
							<h6 class="mb-0">Recherche Reservation Par Salle</h6>
						</div>
						<div class="card-body">
							<form action="RechercheReservationController" method="POST" role="form"
								class="text-start">
								...
								<div style="display: none"
									...
									<span class="text-sm">Veuillez choisir une salle</span>
									<button type="button" class="btn-close text-lg py-3 opacity-10"
										data-bs-dismiss="alert" aria-label="Close">
										<span aria-hidden="true">×</span>
									</button>
								...
								<div class="text-center">
									<button id="Recherche" type="button"
										class="RechercheReservation btn bg-gradient-primary w-100 my-4 mb-2">Rechercher</button>
								</div>
