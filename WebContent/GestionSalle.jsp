...
<script src="script/salle.js"></script>
				...
				<div class=" mt-4">
					<div class="card">
						<div class="card-header pb-0 px-3">
							<h6 class="mb-0">Nouvelle Salle</h6>
						</div>
						<div class="card-body">
							<form action="SalleController" method="POST" role="form"
								class="text-start">
								<div class="input-group input-group-outline my-3">
									<label class="form-label">Type</label> <input id="type"
								...
								<div class="text-center">
									<button id="ajouterSalle" type="button"
								...
								<div id="modifier" class="text-center">
									<button style="display: none" type="button" id="mm"
										class="modifierSalle btn bg-gradient-success w-100 my-4 mb-2">Modifier</button>
								</div>
								...
								<table class="table align-items-center mb-0">
									<thead>
										<tr>
											...
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Type</th>
											<th
