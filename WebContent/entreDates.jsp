...
<title>Recherche des reservations entre deux dates</title>
<script src="script/jquery-3.6.0.min.js"></script>
<script src="script/reservationEntreDate.js"></script>
				...
				<div class=" mt-4">
					<div class="card">
						<div class="card-header pb-0 px-3">
							<h6 class="mb-0">Recherche Reservation Entre Deux Dates</h6>
						</div>
						<div class="card-body">
							<form action="EntreDateController" method="POST" role="form"
								class="text-start">
								<h6 class="mb-1 text-secondary ">Premiere Date</h6>
								<div class="input-group input-group-outline mb-3">
									<label class="form-label"></label> <input id="dateReservationUn"
										type=date class="form-control" onfocus="focused(this)"
										onfocusout="defocused(this)">
								</div>
								<h6 class="mb-1 text-secondary ">Deuxieme Date</h6>
								<div class="input-group input-group-outline mb-3">
									<label class="form-label"></label> <input id="dateReservationDeux"
										type=date class="form-control" onfocus="focused(this)"
										onfocusout="defocused(this)">
								</div>
								...
								<div style="display: none"
									...
									<span class="text-sm">Aucune Reservation n'a été trouvé</span>
