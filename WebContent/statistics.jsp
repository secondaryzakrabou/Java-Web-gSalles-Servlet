					...
					<div class="card">
						<div class="card-header p-3 pt-2">
							...
							<div class="text-end pt-1">
								<p class="text-sm mb-0 text-capitalize">Nombre de Reservations</p>
								<h4 id="nombreReservation" class="mb-0">$53k</h4>
							</div>
						</div>
					...
					<div class="card">
						<div class="card-header p-3 pt-2">
							...
							<div class="text-end pt-1">
								...
								<h4 id="nombreSalle" class="mb-0">2,300</h4>
							</div>
						</div>
						<hr class="dark horizontal my-0">
						<div class="card-footer p-3"></div>
				...
				<div class="col-md-5 mt-4 ">
					<div class="card z-index-2  ">
						...
						<div class="card-body">
							...
							<p class="text-sm ">Nombre de reservations par salle</p>
				...
				<div class="col-md-6 mt-4">
					<div class="card z-index-2  ">
						...
						<div class="card-body">
							...
							<p class="text-sm ">Nombre de reservation par salle</p>
							<hr class="dark horizontal">
